...
export const parseWorldStudioDocument = (value: unknown, definition: EnvironmentDefinition): WorldStudioEnvironmentDocument | null => {
  ...
  return {
    ...
    fogDensity: clamp(document.fogDensity, 0.0036, 0, 0.04),
    weather: WEATHERS.has(document.weather as WeatherKind) ? document.weather as WeatherKind : "clear",
    weatherStrength: clamp(document.weatherStrength, 0, 0, 1),
