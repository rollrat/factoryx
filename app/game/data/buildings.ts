...
const OPERATIONAL_SPECS: Readonly<Record<string, Partial<BuildingDefinition>>> = {
  ...
  pipe_mk1: { transportPolicy: { throughputPerMinute: 60 } },
  pipe_t_junction: { transportPolicy: { throughputPerMinute: 60 } },
  pipe_pump: { transportPolicy: { throughputPerMinute: 60 } },
...
export const START_BUILDINGS = [
  ...
  building("distribution_pole_mk2", "배전 기둥 Mk.2", "phase_2_complete", { x: 1, z: 1 }, [power("grid_a", "bidirectional", "power_local", -1, 0, -0.5, 0, -1), power("grid_b", "bidirectional", "power_local", 1, 0, 0.5, 0, 1), power("grid_c", "bidirectional", "power_local", 0, -1, 0, -0.5, 0), power("grid_d", "bidirectional", "power_local", 0, 1, 0, 0.5, 0)], [], cost(["steel_billet", 8], ["copper_wire", 12], ["electromagnetic_coil", 2])),
