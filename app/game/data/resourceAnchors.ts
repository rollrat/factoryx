...
export const RESOURCE_ANCHORS = [
  ...
  { id: "coal_vein_a17", itemId: "coal", position: { x: 8, z: -7 }, extractionBuildingId: "vein_miner", recipeId: "mine_coal", unlockId: "phase_1_complete", medium: "solid" },
  { id: "quartz_vein_a17", itemId: "quartz", position: { x: -10, z: 10 }, extractionBuildingId: "vein_miner", recipeId: "mine_quartz", unlockId: "phase_2_complete", medium: "solid" },
  { id: "crude_oil_well_a17", itemId: "crude_oil", position: { x: 10, z: -2 }, extractionBuildingId: "fluid_extractor", recipeId: "extract_crude_oil", unlockId: "phase_3_complete", medium: "fluid" },
  { id: "bauxite_vein_a17", itemId: "bauxite", position: { x: -11, z: -9 }, extractionBuildingId: "vein_miner", recipeId: "mine_bauxite", unlockId: "chemistry_stable", medium: "solid" },
  { id: "tungsten_vein_a17", itemId: "tungsten_ore", position: { x: 11, z: -10 }, extractionBuildingId: "vein_miner", recipeId: "mine_tungsten_ore", unlockId: "thermal_verified", medium: "solid" },
