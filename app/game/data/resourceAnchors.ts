...
export const RESOURCE_ANCHORS = [
  ...
  { id: "coal_vein_a17", itemId: "coal", position: { x: 68, z: -54 }, extractionBuildingId: "vein_miner", recipeId: "mine_coal", unlockId: "phase_1_complete", medium: "solid" },
  { id: "quartz_vein_a17", itemId: "quartz", position: { x: -66, z: 20 }, extractionBuildingId: "vein_miner", recipeId: "mine_quartz", unlockId: "phase_2_complete", medium: "solid" },
  { id: "crude_oil_well_a17", itemId: "crude_oil", position: { x: 72, z: 58 }, extractionBuildingId: "fluid_extractor", recipeId: "extract_crude_oil", unlockId: "phase_3_complete", medium: "fluid" },
  { id: "bauxite_vein_a17", itemId: "bauxite", position: { x: -62, z: -75 }, extractionBuildingId: "vein_miner", recipeId: "mine_bauxite", unlockId: "chemistry_stable", medium: "solid" },
  { id: "tungsten_vein_a17", itemId: "tungsten_ore", position: { x: 12, z: 99 }, extractionBuildingId: "vein_miner", recipeId: "mine_tungsten_ore", unlockId: "thermal_verified", medium: "solid" },
