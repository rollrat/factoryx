...
& $BlenderPath --background --factory-startup --python (Join-Path $AssetDir "build_landmark_pressure_vent_a.py") --python-exit-code 1 -- --source $Source --preview $Preview --asset-id $AssetId
