...
& $BlenderPath --background --factory-startup --python (Join-Path $AssetDir "build_landmark_twin_needles_a.py") --python-exit-code 1 -- --source $Source --preview $Preview --asset-id $AssetId
