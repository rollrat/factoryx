...
$Builder = Join-Path $PSScriptRoot "build_landmark_great_sail_a.py"
...
if ($header.Length -lt 20 -or [BitConverter]::ToUInt32($header, 0) -ne 0x46546C67 -or [BitConverter]::ToUInt32($header, 4) -ne 2) { throw "Invalid GLB header" }
