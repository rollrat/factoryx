...
& $BlenderPath --background --factory-startup --python (Join-Path $PSScriptRoot "build_flora_sail_membrane_a.py") --python-exit-code 1 -- --source $Source --preview $Preview --asset-id $AssetId
...
# The repository GLB validator rewrites the shared manifest, so retain this
# asset-only glTF header check instead.
